...
if __name__ == '__main__':
    ...
    if args.variant == 'vanilla':
        # note to self. confusing that they load the model module, then below expect model to be pytorch model
    ...
    if args.function == 'pretrain':
        ...
        b_s=128 # official
        tconf = trainer.TrainerConfig(max_epochs=650, batch_size=b_s, learning_rate=args.pretrain_lr,
        ...
        m_e = 10 if args.reading_params_path else 75
        b_s=256 # official
        # b_s=128 # so i can use my GPU
        tconf = trainer.TrainerConfig(max_epochs=m_e, batch_size=b_s, learning_rate=args.finetune_lr,
                              lr_decay=True, warmup_tokens=512*20, final_tokens=200*len(pretrain_dataset)*block_size,
                              num_workers=4, writer=writer)
